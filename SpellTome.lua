...
local SpellTomeHiddenTooltip = CreateFrame("GameTooltip", "SpellTomeHiddenTooltip", nil, "GameTooltipTemplate")
SpellTomeHiddenTooltip:SetOwner(UIParent, "ANCHOR_NONE")

local function GetSpellTooltipText(spellId)
    SpellTomeHiddenTooltip:ClearLines()
    SpellTomeHiddenTooltip:SetHyperlink("spell:" .. spellId)
    local desc = ""
    for i = 2, SpellTomeHiddenTooltip:NumLines() do -- skip line 1 (spell name)
        local left = _G["SpellTomeHiddenTooltipTextLeft" .. i]
        if left and left:GetText() then
            desc = desc .. " " .. left:GetText()
        end
    end
...
-- Tab 1 "Show All" spell list
local spellsAllSpells = {
    10,17,53,78,99,100,116,118,120,122,
    133,136,139,168,172,331,348,370,403,408,
    465,467,469,543,585,587,588,589,596,604,
    633,635,657,686,687,688,689,693,697,702,
    703,706,710,724,729,740,755,759,772,774,
    779,845,853,871,879,974,976,980,1008,1022,
    1064,1079,1082,1098,1120,1126,1130,11327,11581,1160,
    13165,1329,13797,13813,13980,1449,1454,1459,1463,1464,
    14752,1490,1495,1499,14914,1513,15237,15407,16511,16689,
    1680,16827,16914,16979,1714,1752,17877,18220,1842,1850,
    1856,19236,19306,19386,1943,1949,19434,19476,1966,1978,
    19740,19742,19750,1978,19876,19888,19891,19975,2006,2008,
    20043,20233,20243,20257,20473,20484,2050,2054,2060,2061,
    2096,2098,2120,2136,21849,22568,22570,23455,2362,23922,
    24275,25782,25894,2637,2643,26573,26679,27243,27576,2812,
    28176,2836,2908,2912,2944,2948,2973,29722,2983,29893,30108,
    30283,3044,30455,30451,30706,31633,31661,31935,32379,32546,
    32645,33745,33763,33876,33878,34861,34913,34914,3599,3674,
    36744,403,41635,42243,42955,43987,44203,44614,45297,45517,
    47897,50516,50518,50577,50582,50769,5143,5171,5176,5185,
    5211,5217,5221,5277,5308,53408,53600,5394,5504,5570,56354,
    56641,5675,5676,5730,5740,5782,587,588,58861,59881,6117,
    61391,6143,61846,6201,6229,6343,6353,6366,6572,6673,6770,
    6785,6807,69305,7302,7384,8004,8024,8033,8042,8050,8056,
    8070,8071,8092,8122,8181,8184,8190,8227,8232,8349,845,
    8676,871,8921,8936,8990,8998,9005,9484,9634,10595,1098,
    11113,11366,11426,12294,12956,13165,13797,13813,16511,16689,
    16827,16914,17877,18220,19306,19386,1943,1949,19434,19476,
    1966,1978,19740,19742,19750,19876,19888,19891,19975,2006,
    2008,20043,20233,20243,20484,2054,2060,2061,2096,2098,2120,
    2136,21849,22568,22570,23455,2362,23922,24275,25782,25894,
    2637,2643,26573,26679,27243,27576,2812,28176,2836,2908,2912,
    2944,2948,2973,29722,2983,29893,30108,30283,3044,30455,30451,
    30706,31633,31661,31935,32379,32546,32645,33745,33763,33876,
    33878,34861,34913,34914,3599,3674,36744
}
-- Tab 2 "Show All" spell list
local tab2AllSpells = {
    12664,13854,21831,12697,12960,12677,12963,12296,16494,12867,12712,56638,12785,12328,12704,
    { 53,408,703,1329,1752,1842,1943,1966,2098,2836,2983,5171,5277,6770,8676,11327,16511,26679 },
    -- Hunter
    { 136,1130,1495,1499,1513,1978,2643,2973,3044,3674,5116,13165,13797,13813,19306,19434,19386,20043,42243,56641,61846 },
    -- Priest
    { 17,139,585,588,589,596,724,976,1243,2006,2050,2054,2060,2061,2096,2944,8092,8122,9484,14752,14914,15237,15407,19236,19476,21562,32379,32546,34861,34914,41635 },
    -- Shaman
    { 324,331,370,403,974,1064,2008,2484,3599,5394,5675,5730,8004,8075,8024,8033,8042,8050,8056,8071,8181,8184,8190,8232,8227,8349,10595,30706,31633,36744,51730,52127 },
    -- Druid
    { 99,339,467,740,774,779,1079,1082,1126,1822,1850,1853,2637,2908,2912,5176,5185,5211,5217,5221,5570,6785,6807,8152,8921,8936,8998,9005,9634,16689,16914,18960,19975,20484,21849,22568,22570,33745,33763,33876,33878,50516,50769 },
    -- Death Knight
    { 113,3714,45462,45477,45529,45902,46585,47528,47541,47568,48263,48265,48680,48707,48743,48721,48792,49020,49143,49998,50977,50689,51426,53276,55050,55090,56222,61999 },
}
...
local subPaladinSeal      = {20271,53408}
...
if not spellClassDropDown then
    spellClassDropDown = CreateDropdown(tabContents[1], "SpellTomeClassDropDown",
        function()
            ...
            BuildSpellsContent("class"); classToggleBtn:Show(); UpdateClassToggleButton()
        end,
        function()
            if spellSearchBox then spellSearchBox:SetText("") end
            BuildSpellsContent("all"); classToggleBtn:Hide()
        end)
end

-- Tab 3 "Show All" spell list
local allSpells = {
    17, 53, 71, 75, 78, 99, 100, 116, 118, 133, 139, 168, 172, 324, 331,
    339, 348, 355, 403, 465, 467, 498, 585, 587, 588, 589, 635, 686, 687, 688,
    697, 768, 772, 774, 779, 853, 921, 980, 1022, 1079, 1082, 1120, 1130, 1152, 1243,
    1454, 1494, 1495, 1515, 1715, 1752, 1776, 1853, 1978, 2006, 2060, 2098, 2136, 2484, 2565,
    2687, 2973, 2983, 3044, 3599, 5116, 5143, 5171, 5185, 5277, 5487, 5504, 5730, 5782, 6117,
    6201, 6343, 6770, 6807, 7165, 8017, 8024, 8042, 8050, 8075, 8092, 8152, 8921, 13163, 16979,
    17364, 18960, 19740, 19883, 20166, 20271, 21084, 25780, 26573, 34428, 35509, 43265, 45462, 45477, 45902,
    47541, 48263, 48265, 48721, 49020, 49376, 49998, 50689, 53408, 53600, 56222, 56641, 58567, 69305,
}
...
spellSearchBox:SetScript("OnTextChanged", function(self)
    ...
    for _, spellId in ipairs(spellsAllSpells) do
        ...
        if name then
            ...
            local tooltipAlpha = GetSpellTooltipText(spellId):gsub("[^a-z]", "")
            if string.find(nameAlpha, query, 1, true) or string.find(tooltipAlpha, query, 1, true) then
...
tab2SearchBox:SetScript("OnTextChanged",  function(self)
    ...
    local searchList = {}
    if val == "all" then
        for _, spellId in ipairs(tab2AllSpells) do table.insert(searchList, spellId) end
    else
        for _, classList in ipairs(tab2ClassSpells) do
            for _, spellId in ipairs(classList) do table.insert(searchList, spellId) end
        end
    end
    local batchSize = 50
    local i = 1
    local total = #searchList
    local function processBatch()
        local startIdx = i
        local endIdx = math.min(i + batchSize - 1, total)
        for idx = startIdx, endIdx do
            local spellId = searchList[idx]
            local name = GetSpellInfo(spellId)
            if name then
                local nameAlpha = string.lower(name):gsub("[^a-z]", "")
                local tooltipAlpha = GetSpellTooltipText(spellId):gsub("[^a-z]", "")
        ...
        if i <= total then
            ...
            if #matches == 0 then
                ...
                AddHeader(ss2, "All Spells", curY)
                curY = curY - HEADER_H - 5
                for j, spellId in ipairs(matches) do
                    MakeIconFrame(ss2, spellId, ICON_SIZE,
                        ICON_MARGIN + ((j-1) % ICONS_PER_ROW) * ROW_H,
                        curY - math.floor((j-1) / ICONS_PER_ROW) * ROW_H)
                end
                curY = curY - math.ceil(#matches / ICONS_PER_ROW) * ROW_H
            end
            ss2.scrollChild:SetHeight(math.max(1, math.abs(curY) + 15))
...
launchBtn:SetWidth(54)
launchBtn:SetHeight(54)
...
local function UpdateLaunchBtnMovable()
    if launchLocked then
        launchBtn:SetMovable(false)
        launchBtn:EnableMouse(true)
    else
        launchBtn:SetMovable(true)
        launchBtn:EnableMouse(true)
...
launchBtn:SetScript("OnDragStart", function(self)
    if not launchLocked then self:StartMoving() end
end)
launchBtn:SetScript("OnDragStop", function(self)
...
local launchBorder = launchBtn:CreateTexture(nil, "BORDER")
launchBorder:SetTexture("interface/playerframe/ui-playerframe-deathknight-goldborder.blp")
launchBorder:ClearAllPoints()
launchBorder:SetPoint("CENTER", launchBtn, "CENTER", 63, -5)
launchBorder:SetWidth(241)
launchBorder:SetHeight(120)
...
local function LaunchBtnDropdownInit(self, level)
    local info = UIDropDownMenu_CreateInfo()
    info.text = launchLocked and "Unlock Button" or "Lock Button"
    info.func = function()
        launchLocked = not launchLocked
        UpdateLaunchBtnMovable()
    end
    UIDropDownMenu_AddButton(info, level)

    info = UIDropDownMenu_CreateInfo()
    info.text = "Hide Button"
    info.func = function()
        launchBtn:Hide()
    end
    UIDropDownMenu_AddButton(info, level)
...
local launchBtnDropdown = CreateFrame("Frame", "SpellTomeLaunchBtnDropdown", UIParent, "UIDropDownMenuTemplate")
UIDropDownMenu_Initialize(launchBtnDropdown, LaunchBtnDropdownInit, "MENU")

launchBtn:SetScript("OnMouseUp", function(self, button)
    if button == "RightButton" then
        ToggleDropDownMenu(1, nil, launchBtnDropdown, self, 0, 0)
...
launchBtn:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine("Left-click: Open Spell Tome", 1, 1, 1)
    GameTooltip:AddLine("Right-click: Lock/Unlock or Hide", 1, 1, 1)
    GameTooltip:Show()
end)
...
SLASH_SPELLTOMEBUTTON1 = "/stbutton"
SlashCmdList["SPELLTOMEBUTTON"] = function(msg)
    if launchBtn:IsShown() then
        launchBtn:Hide()
    else
        launchBtn:Show()
    end
